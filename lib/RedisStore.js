...
module.exports = class RedisStore extends Base {
    ...
    deleteEdge(args = {}) {
        ...
        const removeFromSet = (fromNode, toNode, direction) => {
            ...
            return this.removeFromSet(fromNodeId, toNode)
                .map(response => {
                    if (response) {
    ...
    setEdge(args = {}, increment = false) {
        ...
        const set = (fromNode, toNode, direction = null) => {
            ...
            if (increment) {
                return this.incrementOnSet(fromNodeId, toNode, args.distance, 1)
            ...
            return this.addToSet(fromNodeId, toNode, args.distance)
