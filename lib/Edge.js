...
module.exports = class Edge {
    constructor(args = {}) {
        ...
        this.incrementEdge = this.store.incrementEdge.bind(this.store);
    ...
    link(args = {}) {
        ...
        const operation = args.absoluteDistance ? this.setEdge : this.incrementEdge;

        return operation(_.extend({}, args, {
