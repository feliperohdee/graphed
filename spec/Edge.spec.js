...
describe('Edge.js', () => {
	...
	describe('constructor', () => {
		...
		it('should have custom node', () => {
			...
			expect(edge.node).to.equal(node);
		});
	...
	describe('allAll', () => {
		...
		it('should throw if wrong distance', done => {
			edge.allAll({
				...
				.subscribe(null, err => {
					expect(err.message).to.equal('distance should be a function with signature "(collectionSize, index): number".');
					done();
				});
		});
			...
			edge.allAll({
				...
				.subscribe(response => {
					...
					expect(response[1][0]).to.deep.contain({
						...
						toNode: '2',
						timestamp: response[1][0].timestamp
					});
					...
					expect(response[2][0]).to.deep.contain({
						...
						toNode: '3',
						timestamp: response[2][0].timestamp
					});
					...
					expect(response[3][0]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '2',
						timestamp: response[3][0].timestamp
					});
					...
					expect(response[4][0]).to.deep.contain({
						...
						distance: 0.999999999999998,
						toNode: '3',
						timestamp: response[4][0].timestamp
					});
					...
					expect(response[5][0]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '3',
						timestamp: response[5][0].timestamp
					});
				}, null, done);
		});
			...
			edge.allAll({
				...
				.subscribe(response => {
					...
					expect(response[0][1]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '0',
						timestamp: response[0][1].timestamp
					});
					...
					expect(response[1][1]).to.deep.contain({
						...
						distance: 0.999999999999998,
						toNode: '0',
						timestamp: response[1][1].timestamp
					});
					...
					expect(response[2][1]).to.deep.contain({
						...
						distance: 0.999999999999999,
						toNode: '0',
						timestamp: response[2][1].timestamp
					});
					...
					expect(response[3][1]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '1',
						timestamp: response[3][1].timestamp
					});
					...
					expect(response[4][1]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '1',
						timestamp: response[4][1].timestamp
					});
					...
					expect(response[5][1]).to.deep.contain({
						...
						distance: 0.999999999999998,
						toNode: '1',
						timestamp: response[5][1].timestamp
					});
					...
					expect(response[6][0]).to.deep.contain({
						...
						distance: 0.999999999999998,
						toNode: '0',
						timestamp: response[6][0].timestamp
					});
					...
					expect(response[6][1]).to.deep.contain({
						...
						distance: 0.999999999999998,
						toNode: '2',
						timestamp: response[6][1].timestamp
					});
					...
					expect(response[7][0]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '1',
						timestamp: response[7][0].timestamp
					});
					...
					expect(response[7][1]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '2',
						timestamp: response[7][1].timestamp
					});
					...
					expect(response[8][0]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '3',
						timestamp: response[8][0].timestamp
					});
					...
					expect(response[8][1]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '2',
						timestamp: response[8][1].timestamp
					});
					...
					expect(response[9][0]).to.deep.contain({
						...
						distance: 0.999999999999999,
						toNode: '0',
						timestamp: response[9][0].timestamp
					});
					...
					expect(response[9][1]).to.deep.contain({
						...
						distance: 0.999999999999999,
						toNode: '3',
						timestamp: response[9][1].timestamp
					});
					...
					expect(response[10][0]).to.deep.contain({
						...
						distance: 0.999999999999998,
						toNode: '1',
						timestamp: response[10][0].timestamp
					});
					...
					expect(response[10][1]).to.deep.contain({
						...
						distance: 0.999999999999998,
						toNode: '3',
						timestamp: response[10][1].timestamp
					});
					...
					expect(response[11][0]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '2',
						timestamp: response[11][0].timestamp
					});
					...
					expect(response[11][1]).to.deep.contain({
						...
						distance: 0.999999999999997,
						toNode: '3',
						timestamp: response[11][1].timestamp
					});
				}, null, done);
		});

		it('should add multiple edges without timestamp', done => {
			edge.allAll({
					collection: ['0', '1', '2', '3'],
					distance: (collectionSize, index) => collectionSize - (index + 1),
					entity: 'entity',
					noTimestamp: true
				})
				.toArray()
				.subscribe(response => {
					...
					expect(response[0][0].timestamp).to.be.undefined;
					expect(response[1][0].timestamp).to.be.undefined;
					expect(response[2][0].timestamp).to.be.undefined;
					expect(response[3][0].timestamp).to.be.undefined;
					expect(response[5][0].timestamp).to.be.undefined;
				}, null, done);
		});
	});
	...
	describe('allByNode', () => {
		...
		it('should fetch all by node only by timestamp', done => {
			Observable.forkJoin(
					edge.allByNode({
						type: 'byTimestamp',
						fromNode: '1'
	...
	describe('closest', () => {
		...
		it('should throw if wrong filter', done => {
			edge.closest({
					entity: 'entity',
					filter: true
				})
				.subscribe(null, err => {
					expect(err.message).to.equal('filter should be a string.');
					done();
				});
		});
	...
	describe('link', () => {
		...
		it('should insert two edges with absoluteDistance without timestamp', done => {
			edge.link({
					absoluteDistance: 0.999999999999999,
					entity: 'entity',
					fromNode: '1',
				...
				.subscribe(response => {
					...
					expect(firstEdge.distance).to.equal(0.999999999999999);
					expect(firstEdge.timestamp).to.be.undefined;
					expect(secondEdge.distance).to.equal(0.999999999999999);
					expect(secondEdge.timestamp).to.be.undefined;
				}, null, done);
		});
